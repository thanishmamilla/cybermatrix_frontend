...
const initialState = {
    isLoggedIn: localStorage.getItem('isLoggedIn') === 'true', // Convert 'true'/'false' strings to boolean
    role: localStorage.getItem('role') || "", // Fallback to empty string if 'role' is not set
    data: localStorage.getItem('data') // Fallback to empty object if 'data' is not set
};
